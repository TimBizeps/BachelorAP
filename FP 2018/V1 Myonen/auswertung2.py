...
kanaele = np.arange(0, 506, 1)
zeiten1 = linear(kanaele, *params_kal)
# Rausnehmen von komischen Werten
zeiten = zeiten1[3:6]
zeiten = np.append(zeiten, zeiten1[1:14])
zeiten = np.append(zeiten, zeiten1[15::])

daten_ang = daten[3:6]
daten_ang = np.append(daten_ang, daten[1:14])
