...
f, Ua = np.genfromtxt('daten3.txt', unpack=True)
f2, Ua2 = np.genfromtxt('daten32.txt', unpack=True)
...
#print('logf = ', logf)
#np.savetxt("logdaten3.txt", np.column_stack([logf,logVstreff]))
#np.savetxt("logdaten32.txt", np.column_stack([logf2,logVstreff2]))
