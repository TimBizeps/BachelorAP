...
\begin{table}
  ...
  \begin{tabular}{S S[table-format=3.0] S[table-format=2.1]}
    ...
    \midrule
    \text{$b_\mathup{Einzel}$} = \SI{75.7(3)}{\micro\meter} & \text{$b_\mathup{Einzel}$} = \SI{75}{\micro\meter} & 0.9\\
    \text{$b_\mathup{Doppel_1}$} = \SI{100(6)}{\micro\meter} & \text{$b_\mathup{Doppel_1}$} = \SI{100}{\micro\meter} & 0\\
    \text{$s_\mathup{Doppel_1}$} = \SI{486(5)}{\micro\meter} & \text{$s_\mathup{Doppel_1}$} = \SI{400}{\micro\meter} & 21.5\\
    \text{$b_\mathup{Doppel_2}$} = \SI{152(3)}{\micro\meter} & \text{$b_\mathup{Doppel_2}$} = \SI{150}{\micro\meter} & 1.3\\
    \text{$s_\mathup{Doppel_2}$} = \SI{238(3)}{\micro\meter} & \text{$s_\mathup{Doppel_2}$} = \SI{250}{\micro\meter} & 4.8\\
    \bottomrule
  \end{tabular}
\end{table}\\
